...
import { getAllShortListProfiles, getUserProfileById, removeShortListProfile, shortListProfile, updateProfile } from '../controllers/profileControler.js';
import fileUpload from '../middlewares/multerUpload.js'; // Make sure this exports correctly
...
profileRouter.post(
  '/updateuserprofile',
  authenticate,
  fileUpload.uploadtophotos.array('file', 12), // For gallery images (optional)
  fileUpload.uploadProfilePic, // For profile picture (single)
  updateProfile
);
